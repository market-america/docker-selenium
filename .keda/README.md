...
```bash
docker pull selenium/keda:2.17.0-selenium-grid-20250414
docker pull selenium/keda-metrics-apiserver:2.17.0-selenium-grid-20250414
docker pull selenium/keda-admission-webhooks:2.17.0-selenium-grid-20250414
```
...
```yaml
  image:
    keda:
      registry: selenium
      repository: keda
      tag: "2.17.0-selenium-grid-20250414"
    metricsApiServer:
      registry: selenium
